...
// for the element in drop_zone part
  ...
  return (
    <Form {...form}>
      <form
        ...
        onSubmit={(e) => {
          e.preventDefault(); // so when submit it dont reload the page
        }}
        className="space-y-3"
      >
        <FormField
            ...
            <FormItem>
              ...
              <FormControl>
                <Input
                  {...field}
                  onKeyDown={(e) => {
                    if (e.key === "Enter") e.currentTarget.blur(); // so when enter its blurs thus saves
                  }}
                />
              </FormControl>
              <FormDescription>
